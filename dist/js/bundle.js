    ...
    elem.addEventListener('submit', function (e) {
      ...
      function postData(data) {
        return new _Promise(function (resolve, reject) {
          ...
          request.send(data); // request.send(json);
        });
      }
...
function modal() {
  var btn = document.querySelectorAll('.description-btn, .more'); // const more = document.querySelector('.more');
